  ...
  <div id="shop">
    ...
    <div class="myshop">
    	<div class="diancan" v-if="flag1">
    		...
    		<div class="right">
    			<div class="foods_list" v-if="foods" v-for="item in foods">
    					<div class="foods_list clear" v-if="item.foods" v-for="it in item.foods">
    	...
    	<div class="pingjia" v-if="flag2">
    		<ul v-if="rating" v-for="item in rating">
    			<li v-if="rating" v-for="item in rating">
...
//			console.log(arr);
			...
			for(var i = 0;i < len; i ++){
				...
				for(var j = 0;j < len2;j ++){
					var str = "";
					if(foods[j].image_path.indexOf("png") != -1 && foods[j].image_path != null){
						str = foods[j].image_path.slice(foods[j].image_path.indexOf("png"))
					}else if(foods[j].image_path != null){
...
//  		console.log(this);
		...
		goToCart(it){
			...
			var img_path = it.foods_img;
			this.num ++;
//			console.log(name,shopname,price,this.num);
			
			this.cart.push({name: resname,shop: [{shopname: foodname,price: fprice,num: this.num,path:img_path}]})
